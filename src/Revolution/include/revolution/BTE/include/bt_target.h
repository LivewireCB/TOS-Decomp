...
#define HCI_BLE_ACL_DATA_TO_LOWER(p)                                           \
  bte_main_hci_send((BT_HDR *)(p),                                             \
                    (UINT16)(BT_EVT_TO_LM_HCI_ACL | LOCAL_BLE_CONTROLLER_ID));
#endif
 ...
 * use a value between 30 and OBX_TIMEOUT_VALUE
...
#define HID_DEV_BUSY_MODE_PARAMS                                               \
  { 320, 160, 10, 20, HCI_MODE_ACTIVE }
#endif

#ifndef HID_DEV_IDLE_MODE_PARAMS
#define HID_DEV_IDLE_MODE_PARAMS                                               \
  { 320, 160, 10, 20, HCI_MODE_SNIFF }
#endif

#ifndef HID_DEV_SUSP_MODE_PARAMS
#define HID_DEV_SUSP_MODE_PARAMS                                               \
  { 640, 320, 0, 0, HCI_MODE_PARK }
#endif
