...
const char *__AIVersion =
    "<< RVL_SDK - AI \trelease build: Feb 27 2009 10:01:30 (0x4302_145) >>";
...
void AIStopDMA() {
  DSP_HW_REGS[DSP_AI_DMA_CSR] = (DSP_HW_REGS[DSP_AI_DMA_CSR] & 0x7FFF);
}
...
u32 AICheckInit() { return __AI_init_flag; }
