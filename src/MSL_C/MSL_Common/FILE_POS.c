...
//     if ((file_mode != 2) && (pFile->mode.io != 3) && ((pFile->state.io_state
//     == reading) || (pFile->state.io_state == rereading))) {
...
//         if (position_proc_func != 0 && (*position_proc_func)(pFile->handle,
//         &offs, file_mode, pFile->ref)) {
//             pFile->state.error = 1;
//             pFile->buffer_len = 0;
//             errno = 40;
//             return -1;
