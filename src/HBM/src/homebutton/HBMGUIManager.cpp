...
#include <MSL_C/include/new> // IWYU pragma: keep (placement new)

#include <macros.h>
#include <types.h>

#include "lyt/lyt_bounding.h"
#include "lyt/lyt_common.h" // nw4hbm::lyt::Size
#include "lyt/lyt_layout.h"
#include "lyt/lyt_pane.h"
#include "lyt/lyt_picture.h"
#include "lyt/lyt_window.h"
...
void Manager::delComponent(Component *pComponent) {
  IDToComponent *p = static_cast<IDToComponent *>(
      nw4hbm::ut::List_GetNext(&mIDToComponent, 0));
...
bool Manager::update(int i, f32 x, f32 y, u32 uTrigFlag, u32 uHoldFlag,
  ...
  bool bTouched = false;
  Component *pLastContainedComponent = 0;
...
//       void *p2 = MEMAllocFromAllocator(mpAllocator, sizeof
//       *pPaneToComponent);
