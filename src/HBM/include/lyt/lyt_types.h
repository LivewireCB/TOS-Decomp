...
struct AlphaCompare {
  ...
  GXCompare GetComp0() const { return static_cast<GXCompare>(comp & 0b1111); }
...
struct TevStageInOp {
  ...
  u8 GetA() const { return ab & 0b1111; }
  u8 GetB() const { return ab >> 4 & 0b1111; }

  u8 GetC() const { return cd & 0b1111; }
  u8 GetD() const { return cd >> 4 & 0b1111; }
  ...
  u8 GetOp() const { return op & 0b1111; }
  u8 GetBias() const { return op >> 4 & 0b11; }
  u8 GetScale() const { return op >> 6 & 0b11; }

  bool IsClamp() const { return cl & 0b1; }
  u8 GetOutReg() const { return cl >> 1 & 0b11; }
  u8 GetKSel() const { return cl >> 3 & 0b11111; }
...
struct TevStage {
  ...
  void SetIndirect(GXIndTexStageID stage, GXIndTexFormat format,
                   GXIndTexBiasSel bias, GXIndTexMtxID mtx, GXIndTexWrap wrapS,
                   GXIndTexWrap wrapT, bool addPrev, bool utcLod,
  ...
  bool IsIndAddPrev() const { return indFoAdUtAl >> 2 & 0b1; }
  bool IsIndUtcLod() const { return indFoAdUtAl >> 3 & 0b1; }
