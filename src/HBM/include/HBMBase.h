...
private:                           // offset goes dvd/nand
...
#endif
  nw4hbm::lyt::Layout
      *mpCursorLayout[WPAD_MAX_CONTROLLERS]; // size 0x010, offset 0x1dc/0x1e8
  nw4hbm::lyt::ArcResourceAccessor
      *mpResAccessor; // size 0x004, offset 0x1ec/0x1f8
#if HBM_APP_TYPE == HBM_APP_TYPE_NAND
  nw4hbm::lyt::MultiArcResourceAccessor
      *mpMultiResAccessor; // size 0x004, offset -----/0x1fc
  nw4hbm::lyt::ArcResourceLink
      *mpHBInfoExLink;                        // size 0x004, offset -----/0x200
  ...
  HomeButtonEventHandler
      *mpHomeButtonEventHandler;   // size 0x004, offset 0x1f4/0x210
  nw4hbm::lyt::DrawInfo mDrawInfo; // size 0x054, offset 0x1f8/0x214
  Controller
      *mpController[WPAD_MAX_CONTROLLERS]; // size 0x010, offset 0x24c/0x268
  RemoteSpk *mpRemoteSpk;                  // size 0x004, offset 0x25c/0x278
#if HBM_APP_TYPE == HBM_APP_TYPE_NAND
  wchar_t
      *at_0x27c[10][1]; // size 0x028, offset -----/0x27c // possibly fakematch?
  ...
  GroupAnmController
      *mpGroupAnmController[74]; // size 0x128, offset 0x290/0x300
  GroupAnmController
      *mpPairGroupAnmController[15]; // size 0x03c, offset 0x3b8/0x428
#if HBM_APP_TYPE == HBM_APP_TYPE_NAND
